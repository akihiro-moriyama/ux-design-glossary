...
note:実利用環境でのシステム更新の後、顧客からのフィードバックを得て次の開発サイクルが始まるため開発と運用は「継続的」となる
...
[UI要素]:#UI要素 "ウィンドウ、ボタン、テキストフィールド、チェックボックス、ラジオボタン、等"

[UI設計要素]:#UI要素 "(→UI要素)ウィンドウ、ボタン、テキストフィールド、チェックボックス、ラジオボタン、等"
...
<1>ある事物が人間に与える満足の度合い <2>｢[アウトカム]｣の代用語

[価値]:#価値 "<1>ある事物が人間に与える満足の度合い <2>｢アウトカム｣の代用語"
...
note:インサイトの本来の意味は「洞察」だが、マーケティング用語としては「消費者本人には自覚のない、消費者の経済行動の動機や根拠」を指す。消費者の経済行動に限った話ではないことを強調するために行動インサイトと表現する
...
note:ユニバーサルデザインの概念は、1985年にノースカロライナ州立大学のロナルド・メイスが提唱した。当時、バリアフリーという言葉が「既存の製品サービスからバリア(障害物)を除去する活動」だと解釈されたことから、最初からバリアのない製品サービスをつくるべきという思想を明確にするためにユニバーサルデザインという言葉を用いた。
