...
note:UXと[UI]は別の概念である。UIの改善は、良いUXの実現という目的を達成する手段のひとつに過ぎない

note:UXと[使いやすさ]は別の概念である。使いやすさ(正確にいえば使いやすいと感じる心理)は体験の一部に過ぎない
...
note:UXデザインは、下記4つの作業を既存の制作工程に追加することで実践される。あくまでも追加であり大幅に制作工程が変わるわけではない。
...
note:観察を行う際は、事前に仮説を用意しない。たとえ事前に仮説があったとしても仮説にとらわれず、観察事実の記録を最優先する
...
note:典型的なユーザーの体験を100％実践する特定個人は確率的に存在し得ないといって良い。単なる思い込みで特定個人を典型だと見なすと事実を誤認する
...
note:d.schoolデザイン思考ではアイデアの発散と収束、すなわち、まず可能な限り数多く幅広くアイデアを出した後に優れたアイデアを絞り込んでいくことが重視される
...
note:品質の定義における｢要求｣とは[ユーザー要求]のことである。経営者の自社製品サービスへの要求(たとえば予算や日程)は管理されるべきビジネス上の重要指標だが、品質の定義からは外れる
