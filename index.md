...
[IA]:#情報アーキテクチャ "情報をわかりやすく伝え、受け手が情報を探しやすくするための技術"
...
[要件]:#設計要件 "ユーザー要求を満たすために実装すべき、製品サービスの機能や性能"
...
[ユースケース記述]:#ユースケース記述 "ユースケースについての具体的な説明の記述"
...
システム工学の用語で、システムにおけるユーザーと[ユースケース]の全体像を図で表現したもの

[ユースケース図]:#ユースケース図 "ユースケースを図で表現したもの"
