...
note:(関連語)[広告医学]、[行動経済学]、[シカケ]、[スラッジ]、[ダークパターン]、[ナッジ]
...
note:たとえば、５皿毎に１回くじをひける回転寿司の卓上会計システムなどが該当する
...
note:廊下テストで既存の[ユーザテスト]すべてを代替することはできない。廊下テストは「誰でも簡単に使いこなせるか否か」を検証するには適しているが、想定対象ユーザーに固有の問題は発見できない
