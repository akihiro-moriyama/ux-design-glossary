...
note:「価値」という言葉を「顧客に価値を感じさせる要素」の意味で使うことがある
...
ユーザーテストにおいて、テスト協力者が進行役に一手順ずつ口頭で操作指示を出し、進行役が代理で評価対象物を操作することでユーザーテストを進めていくユーザーテスト手法
...
ユーザーテストにおいて、テスト協力者が評価対象物を操作しつつ、操作の各手順ごとに感じた印象や予想した次の手順について語ることでユーザーテストを進めていくユーザーテスト手法
...
note:ひとつのフィーチャーには必ずひとつの価値(正確には"価値を感じさせる要素")がある
