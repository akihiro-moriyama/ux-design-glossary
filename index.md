...
note:顧客が価値と認識するものだけが顧客価値である。顧客価値の大小は顧客の内心の評価基準でしか計れない
...
note:商品コンセプトは製品サービスの特徴を表現したものではない。たとえば｢1920年代のアメリカンダイナーを模したレトロな雰囲気のカフェ｣は特徴の説明であってコンセプトではない
...
｢きっかけ→行動→報酬｣を繰り返すことで行動を習慣化できるとする理論(例：朝起きたら歯を磨くと決める→実行する→口の中が爽快になる→歯磨きが習慣化する)

note:報酬は、受け取る側が報酬と認識できるものだけが報酬である。もしも他人の行動を変えたい場合、自分の価値観で決めた報酬を相手に押し付けても効果は出ない

note:金銭に換算できないものも報酬になり得る。たとえば「褒める」という行為は報酬になり得る

note:｢習慣｣とは、｢学習により後天的に獲得され、繰り返し行われた結果、比較的固定化するに至った反応様式｣のこと(大辞林より)。すなわち習慣とは無意識の反応であり、反復行動で身につけることができる。
