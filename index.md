...
note:カスタマージャーニーマップと[現状シナリオ]とは、表現方法が異なるだけで、どちらも｢典型的な[ユーザー]の[体験]｣を表現している
...
note:[カスタマージャーニーマップ]と現状シナリオとは、表現方法が異なるだけで、どちらも｢典型的な[ユーザー]の[体験]｣を表現している
...
note:UXデザインでは、｢なんのため｣は[ユーザーゴール]、｢どんな状況で｣は[現状シナリオ]として取り扱っている
...
note:例外的に、[ユーザータスク]の上位にある[ユーザーゴール]から直接的にユーザー要求が発生する場合がある。[ユーザーゴール]と[ユーザータスク]は大目標と小目標の関係にある
