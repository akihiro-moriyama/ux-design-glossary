...
note:UXと使いやすさは別の概念である。使いやすさ(正確にいえば使いやすいと感じる心理)はUXの一部に過ぎない
...
note:ユーザーゴールと[ユーザータスク]とは、大目標と中間目標の関係にあり、どちらも目標と称される場合がある。
...
note:UXデザインにおいては、ユーザータスクは[理想シナリオ] (アクティビティ記述)の描写から考察して得る
...
note:[ユーザーゴール]とユーザータスクとは、大目標と中間目標の関係にあり、どちらも目標と称される場合がある。
...
note:まれに、ユーザー要求が[ユーザーゴール]に対する要求としてしか記述できないことがある。そのような場合はそのまま[ユーザーゴール]に対する要求として記述する。[ユーザーゴール]と[ユーザータスク]とは大目標と中間目標の関係にある
