...
note:UXとUIとは次元の違う別概念である。UIの改善は良いUXという目的を達成する手段のひとつに過ぎない
...
note:解釈とは学術論文でいうところの｢考察｣のことである
...
note:顧客集団のニーズが最初から判明しているわけではない。[基本属性]が似ていれば似たニーズを抱えているはずだという仮説によって細分化した後、ユーザー調査によって実際のニーズを探る
...
note:｢バリュー｣は製品サービスがユーザーに提供する本質的な価値であり、｢ユーザーゴール｣はユーザーの内心にあるあいまいで矛盾したニーズを元にサービス提供側が実現可能な目標としてユーザーに逆提案したものである。バリューとユーザーゴールは一致する
...
note:ユーザーにとって重要な利用文脈がなく｢あらゆる状況でユーザータスク〇〇を達成できること｣としか言えない場合は、｢ユーザーはこの製品サービスを用いて、ユーザータスク〇〇を達成できること｣の形に省略して良い。
...
note:｢インプット｣ 事業を実施するために必要な資金や人材等の資源(いわゆるヒト・モノ・カネ)

note:｢活動｣ 事業を通じて提供される製品サービスを生み出すための具体的な事業活動

note:｢アウトプット｣ 事業を通じて提供される製品サービス

note:｢アウトカム｣ 事業のアウトプットがもたらす変化、便益、学び、その他効果

note:[UXデザイン]では[UX(ユーザー体験)]がアウトカムに相当する
