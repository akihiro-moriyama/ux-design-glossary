...
note:ユースケースは、｢ユーザー情報を登録する｣｢購入履歴を検索する｣等の、ユーザーの立場で書かれた簡潔な文章の形で記述する。各ユースケースの具体的手順は[ユースケース記述]として別紙記述する

note:ひとくちにユーザーといっても実際にはシステムとの関わり方の違いによって多様に分類され、さらには人間でない別システムがシステムを利用することもある。ユーザーが多様であることを強調するため、ユーザーの代用語として｢アクター｣という用語を用いる
...
note:記述方法に決まった定義はないが、一般的には｢ユースケース名｣｢ユーザー(アクター)｣｢利用前状態｣｢手順｣｢例外処理の手順｣｢利用後状態｣を記述する
