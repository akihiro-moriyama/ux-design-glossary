...
note:｢ユーザータスク｣は、システム工学における｢[ユースケース]｣とほぼ同じ意味である
...
note:ユースケースは、｢ユーザー情報を登録する｣｢購入履歴を検索する｣等の、ユーザーの立場で書かれた簡潔で平易な短文の形で記述する

note:各ユースケースの具体的手順は[ユースケース記述]として別紙記述する
...
ユースケースについての具体的な説明の記述

[ユースケース記述]:#ユースケース記述 "ユースケースについての具体的な説明の記述"

note:記述方法に決まった定義はないが、一般的には｢ユースケース名｣｢ユーザー(アクター)｣｢事前の状態｣｢手順｣｢例外処理の手順｣｢事後の状態｣を記述する
