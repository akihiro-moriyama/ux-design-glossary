...
note:キャッチフレーズとは別物であることに注意。キャッチフレーズは消費者の関心を引くために奇抜な言葉やあいまいな表現で商品を説明したもの
...
[ナッジ]を悪用し、サービス提供側が自分に都合の良い行動([ユーザー]自身にとっては不利な行動)を[ユーザー]に取らせるよう誘導する行為

[スラッジ]:#スラッジ "ナッジを悪用し、サービス提供側が自分に都合の良い行動(ユーザー自身にとっては不利な行動)をユーザーに取らせるよう誘導する行為"
...
心理学的知見を悪用し、サービス提供側が自分に都合の良い行動([ユーザー]自身にとっては不利な行動)を[ユーザー]に取らせるよう誘導するデザインの総称

→(類義語)[スラッジ]

[ダークパターン]:#ダークパターン "心理学的知見を悪用し、サービス提供側が自分に都合の良い行動(ユーザー自身にとっては不利な行動)をユーザーに取らせるよう誘導するデザインの総称"
