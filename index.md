...
note:道徳や善など、金銭と交換できないものにも価値はある

note:商品企画やマーケティングにおいては「価値」という言葉は「顧客に価値を感じさせる要素」の意味で使われることが多い。例えば「この製品の本質的顧客価値は〇〇である」とは「顧客に価値を感じさせる本質的な要素は〇〇である」という意味である
...
ジョブ理論の用語で、ある特定のシチュエーションで顧客が成し遂げたい進捗

note:｢ジョブ｣は大目標を達成するための具体的で小規模な中間目標という意味合いがある

### ジョブ理論

｢購入｣を｢ジョブ(片付けるべき仕事)をこなすために製品サービスを雇うこと｣と再解釈することで、視座を転換して製品サービスの改善やイノベーションの実現につなげる、ビジネスの方法論
...
note:ナッジとは、バイアス(人間の本能的に持つ価値判断の偏り)を利用して人間の行動をコントロールするテクニック。発案者は政府の財政支出削減を意図して発案した
