...
マーケティングの用語で、ユーザーが製品サービスを利用して[ユーザーゴール]に至る過程で得る一連の体験

[カスタマージャーニー]:#カスタマージャーニー "マーケティングの用語で、ユーザーが製品サービスを利用して[ユーザーゴール]に至る過程で得る一連の体験"

note:[UX]（ユーザー体験）は断片的な短時間の体験を指す場合があるが、カスタマージャーニーは必ず一連の体験全体を指す
